                ...
                <div class="card">
                    ...
                    <div id="tabs">
                        <ul class="nav nav-tabs profile-tab" role="tablist">
                            <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#home" role="tab"> Xem Dự Án </a> </li>
                            <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#tasks" role="tab">Nhiệm Vụ Dự Án </a> </li>
                            <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#office" role="tab">Công Việc Văn Phòng </a> </li>
                            <!--<li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#field" role="tab">Field tasks </a> </li>-->
                            <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#education" role="tab"> Tệp Dự Án</a> </li>
                            <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#experience" role="tab"> Ghi Chú </a> </li>
                            <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#expenses" role="tab"> Chi phí</a> </li>
                            <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#logid" role="tab"> Hậu Cần</a> </li>
                        </ul>
                        <!-- Tab panes -->
                        <div class="tab-content">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body"> <small class="text-muted">Ngày Bắt Đầu </small>
                                                <h6><?php echo $details->pro_start_date; ?></h6> <small class="text-muted p-t-30 db">Ngày Kết Thúc</small>
                                                <h6><?php echo $details->pro_end_date; ?></h6> <small class="text-muted p-t-30 db">Trạng Thái</small>
                                                ...
                                                <form method="post" action="Add_Projects" id="btnSubmit" enctype="multipart/form-data">
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label">Tiêu Đề Dự Án</label>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="message-text" class="control-label">Tổng Quan Dự Án</label>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control custom-select" data-placeholder="Choose a Category" tabindex="1" name="prostatus" <?php if ($this->session->userdata('user_type') == 'EMPLOYEE') { ?> readonly <?php } ?> required>
                                                                ...
                                                                <option value="upcoming">Sắp Hoàn Thiện</option>
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="submit" <?php if ($this->session->userdata('user_type') == 'EMPLOYEE') { ?> disabled <?php } ?> class="btn btn-success">Gửi</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                            ...
                            <div class="tab-pane" id="tasks" role="tabpanel">
                                <div class="card">
                                    <div class="card-body">
                                        <h3 class="card-title">Nhiệm Vụ Dự Án</h3>
                            ...
                            <div class="tab-pane" id="office" role="tabpanel">
                                <div class="card">
                                    <div class="card-body">
                                        <h3 class="card-title">Công Việc Văn Phòng</h3>
                                        <span class="pull-right">
                                            <?php if ($this->session->userdata('user_type') != 'EMPLOYEE') { ?>
                                                <a data-toggle="modal" data-target="#tasksmodel" data-whatever="@getbootstrap" class="text-white btn btn-info"> Thêm Nhiệm Vụ</a></span> <?php } ?>
                                    <div class="table-responsive " id="">
                                        <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                            ...
                            <div class="tab-pane" id="field" role="tabpanel">
                                <div class="card">
                                    <div class="card-body">
                                        <h3 class="card-title">Nhiệm Vụ Công Tác</h3>
                                        <span class="pull-right">
                                            <?php if ($this->session->userdata('user_type') != 'EMPLOYEE') { ?>
                                                <a data-toggle="modal" data-target="#fieldmodel" data-whatever="@getbootstrap" class="text-white btn btn-info"> Thêm Công Tác</a></span> <?php } ?>
                                    <div class="table-responsive " id="">
                                        <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive ">
                                            <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                                <thead>
                                                    <tr>
                                                        <th>Chi Tiết Tệp Tin</th>
                                                        <th>Tệp Tin</th>
                                                        <th>Nhân Viên Được Chỉ Định</th>
                                                        <th>Hoạt Động </th>
                                                    </tr>
                                                </thead>
                                                <!-- <tfoot>
                                    ...
                                    <th>Status </th>
                                        ...
                                        <form class="row" action="Add_Pro_Notes" method="post" enctype="multipart/form-data" id="notesform">
                                            ...
                                            <div class="form-actions col-md-12">
                                                ...
                                                <input type="hidden" name="proid" value="<?php echo $details->id; ?>">
                                                <button <?php if ($this->session->userdata('user_type') == 'EMPLOYEE') { ?> disabled <?php } ?> type="submit" class="btn btn-success"> <i class="fa fa-check"></i> Lưu</button>
                                                <button type="button" class="btn btn-info">Huỷ</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane" id="assets" role="tabpanel">
                                ...
                                <tr>
                                    ...
                                    <form class="row">
                                        <div class="form-group col-md-6 m-t-5">
                                            <label class="">Hồ Sơ Nhân Viên</label>
                                            <input type="file" name="file" class="form-control" required="" aria-invalid="false">
                                        </div>
                                        <div class="form-group col-md-6 m-t-5">
                                            <label class="">Bằng Tốt Nghiệp</label>
                                            <input type="file" name="file" class="form-control" required="" aria-invalid="false">
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <button class="btn btn-success">Đăng Tải Thư Mục</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                            ...
                            <div class="tab-pane" id="logid" role="tabpanel">
                                <div class="card">
                                    <div class="card-body">
                                        <a data-toggle="modal" data-target="#logisticmodel" data-whatever="@getbootstrap" class="text-white btn btn-info">Hỗ Trợ Hậu Cần</a>
                                        <div class="table-responsive ">
                                            <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                                <thead>
                                                    <tr>
