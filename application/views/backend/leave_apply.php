...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor"><i class="fa fa-fighter-jet" style="color:#1976d2"> </i> Đơn Xin Nghỉ Phép</h3>
        </div>
            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white"> Danh Sách Đơn Xin Nghỉ
                        </h4>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="span pull-right">
                                    <button class="btn btn-info fetchLeaveTotal">Tổng Số Ngày Nghỉ Phép</button>
                                </div>
                                <br>
                            </div>
                            <div class="form-group">
                                ...
                                <label for="radio_2">Một Ngày</label>
                            ...
                            <div class="form-group">
                                <label class="control-label" id="hourlyFix">Ngày Bắt Đầu</label>
