...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor"><i class="fa fa-map-o"></i> Hỗ Trợ Hậu Cần </h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active"><i class="fa fa-bars" aria-hidden="true"></i> Hỗ Trợ Hậu Cần </li>
            </ol>
        </div>
    </div>
    <div class="container-fluid">
        <div class="row m-b-10">
            <div class="col-12">
                <button type="button" class="btn btn-info"><i class="fa fa-plus"></i><a data-toggle="modal" data-target="#supportmodel" data-whatever="@getbootstrap" class="text-white"><i class="" aria-hidden="true"></i> Thêm Hỗ Trợ Hậu Cần</a></button>
                <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url(); ?>Projects/All_Assets" class="text-white"><i class="" aria-hidden="true"></i> Danh Sách Vật Dụng</a></button>
                <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url(); ?>Logistice/Logistic_Support" class="text-white"><i class="" aria-hidden="true"></i> Hỗ Trợ Hậu Cần</a></button>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white"> Danh Sách Hỗ Trợ Hậu Cần</h4>
                    </div>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content ">
                    <div class="modal-header">
                        <h4 class="modal-title" id="exampleModalLabel1"><i class="fa fa-map-o"></i> Thêm Hậu Cần </h4>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">Danh Sách Hậu Cần</label>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label">Danh Sách Nhiệm Vụ</label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label">Phân Bố Số Lượng</label>
        ...
        <div class="modal fade" id="supportmodelupdate" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content ">
                    <div class="modal-header">
                        <h4 class="modal-title" id="exampleModalLabel1">Cập Nhật Thông Tin Hậu Cần </h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    </div>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control custom-select assetsstock" data-placeholder="Choose a Category" tabindex="1" name="logid" required>
                                            <option value="">Chọn Hậu Cần</option>
                                            <?php foreach ($assets as $value): ?>
                                                <option value="<?php echo $value->ass_id; ?>"><?php echo $value->ass_name; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label">Người Được Chỉ Định</label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label">Ngày hoàn Trả</label>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label">Số Lượng Hoàn Trả</label>
