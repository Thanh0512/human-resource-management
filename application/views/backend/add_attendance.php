...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="row m-b-10">
            <div class="col-12">
                <button type="button" class="btn btn-info"><i class="fa fa-plus"></i><a href="<?php echo base_url(); ?>attendance/Attendance" class="text-white"><i class="" aria-hidden="true"></i> Danh Sách Chấm Công</a></button>
            ...
            <div class="col-6">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white"> Chấm Công </h4>
                    </div>
                    <div class="card-body">
                        <form method="post" action="Add_Attendance" id="holidayform" enctype="multipart/form-data">
                            <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <select class="form-control custom-select" data-placeholder="Chọn Nhân Viên" tabindex="1" name="emid" required>
                                ...
                                <div class="form-group">
                                    <label class="m-t-20">Thời Gian Bắt Đầu Ca</label>
                                    <input class="form-control" name="signin" id="single-input" value="<?php if (!empty($attval->signin_time)) {
                                                                                                            echo  $attval->signin_time;
                                                                                                        } ?>" placeholder="Now" required>
                                </div>
                                <div class="form-group">
                                    <label class="m-t-20">Thời Gian Kết Thúc Ca</label>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" id="attendanceUpdate" class="btn btn-success">Gửi</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content ">
                    <div class="modal-header">
                        <h4 class="modal-title" id="exampleModalLabel1">Ngày Lễ</h4>
                    ...
                    <form method="post" action="Add_Holidays" id="holidayform" enctype="multipart/form-data">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label class="control-label">Tên Ngày Lễ</label>
                            ...
                            <div class="form-group">
                                <label for="message-text" class="control-label"> Năm</label>
