...
<div class="page-wrapper">
  ...
  <div class="row page-titles">
    <div class="col-md-5 align-self-center">
      <h3 class="text-themecolor"><i class="fa fa-money"></i> Xem Bảng Lương
      </h3>
    </div>
    <div class="col-md-7 align-self-center">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Xem Bảng Lương
        </li>
      </ol>
    </div>
  </div>
      ...
      <div class="col-12">
        <div class="card card-outline-info">
          <div class="card-header">
            <h4 class="m-b-0 text-white"> Danh Sách Lương Tháng
            </h4>
          </div>
          <div class="card-body">
                  ...
                  <div class="card-body">
                    <form method="post" action="" id="salaryform" class="form-material row">
                      ...
                      <div class="form-group col-md-3">
                        <button style="float:left;margin-top:23px" type="submit" id="BtnSubmit" class="btn btn-success">Gửi</button>
                      </div>
                    </form>
                  </div>
                </div>
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content ">
          <div class="modal-header">
            <h4 class="modal-title" id="">Sắp Xếp Lương
            </h4>
          ...
          <form method="post" action="pay_salary_add_record" id="generatePayrollForm" enctype="multipart/form-data">
            <div class="modal-body">
              <div class="form-group row">
                <label class="control-label text-left col-md-3">Nhân Viên</label>
                <div class="col-md-9">
              ...
              <div class="form-group row">
                <label class="control-label text-left col-md-3">Tháng
                </label>
                <div class="col-md-9">
              ...
              <div class="row well">
                <div class="col-md-6">
                  <div class="form-group row">
                    <label class="control-label text-left col-md-5">Lương Cơ Bản
                    </label>
                    <div class="col-md-7">
                  ...
                  <div class="form-group row">
                    <label class="control-label text-left col-md-5">Số Giờ Làm Việc
                    </label>
                    <div class="col-md-7">
                  ...
                  <div class="form-group row">
                    <label class="control-label text-left col-md-5">Số Giờ Đã Làm
                    </label>
                    <div class="col-md-7">
                      <input type="text" name="hours_worked" class="form-control hours_worked" id="" value="">
                      <span>Làm việc Không Lương:</span><span class="wpay"></span> <span>hrs</span>
                    </div>
                  </div>
                  ...
                  <div class="form-group row" id="addition">
                    <label class="control-label text-left col-md-5">Trợ Cấp
                    </label>
                    <div class="col-md-7">
                  ...
                  <div class="form-group row">
                    <label class="control-label text-left col-md-5">Ngày Trả Lương
                    </label>
                    <div class="col-md-7">
                ...
                <div class="col-md-6">
                  <div class="form-group row" id="diduction">
                    <label class="control-label text-left col-md-5">Khấu Trừ
                    </label>
                    <div class="col-md-7">
                  ...
                  <div class="form-group row" id="loan">
                    <label class="control-label text-left col-md-5">Khoản Vay
                    </label>
                    <div class="col-md-7">
                  ...
                  <div class="form-group row">
                    <label class="control-label text-left col-md-5">Mức Lương Cuối Cùng
                    </label>
                    <div class="col-md-7">
              ...
              <div class="form-group row" style="margin-top: 25px;">
                <label class="control-label text-left col-md-3">Phương Thức Trả </label><br>
                <div class="col-md-9">
                  <input name="paid_type" type="radio" id="radio_3" data-value="Hand Cash" class="" value="Hand Cash" checked="checked">
                  <label for="radio_3" style="margin-left: 30px">Tiền Mặt</label>
                  <input name="paid_type" type="radio" id="radio_4" data-value="Bank" class="type" value="Bank">
                  <label for="radio_4" style="margin-left: 130px">Ngân Hàng</label>
                </div>
              </div>
            </div>
