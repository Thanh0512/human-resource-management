        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content ">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalLabel1">Thêm Nhiệm Vụ</h4>
                ...
                <form method="post" action="Add_Tasks" id="tasksModalform" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            <label class="control-label col-md-3">Ngày thực hiện</label>
                        ...
                        <div class="form-group row">
                            <label class="control-label col-md-3">Người Thực Hiện</label>
                            <select class="select2 form-control custom-select col-md-3" data-placeholder="Chọn Người Thực Hiện" style="width:25%" tabindex="1" name="teamhead">
                                <option value="">Chọn</option>
                                <?php foreach ($employee as $value): ?>
                                    <option value="<?php echo $value->em_id; ?>"><?php echo $value->first_name . ' ' . $value->last_name; ?></option>
                                <?php endforeach; ?>
                            </select>
                            <label class="control-label col-md-2">Cộng Sự</label>
                            <select class="select2 form-control select2-multiple col-md-3" data-placeholder="Chọn Cộng Sự" multiple="multiple" style="width:25%" tabindex="1" name="assignto[]">
                                <option value="">Chọn</option>
                                <?php foreach ($employee as $value): ?>
                                    <option value="<?php echo $value->em_id; ?>"><?php echo $value->first_name . ' ' . $value->last_name; ?></option>
                                <?php endforeach; ?>
                        ...
                        <div class="form-group row">
                            <label class="control-label col-md-3">Tiêu Đề Nhiệm Vụ</label>
