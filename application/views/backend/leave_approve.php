...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> Đơn Xin Nghỉ Phép</h3>
        </div>
    ...
    <div class="container-fluid">
        <div class="row m-b-10">
            ...
            ?>
            <div class="col-12">
                <button type="button" class="btn btn-info"><i class="fa fa-plus"></i><a data-toggle="modal" data-target="#appmodel" data-whatever="@getbootstrap" class="text-white"><i class="" aria-hidden="true"></i> Thêm Đơn Nghỉ Phép </a></button>
                <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url(); ?>leave/Holidays" class="text-white"><i class="" aria-hidden="true"></i> Danh Sách Ngày Lễ</a></button>
            </div>
            <?php // } 
            ?>
        </div>
            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white"> Danh Sách Đơn Xin Nghỉ Phép
                        </h4>
                    </div>
                    <div class="card-body">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content ">
                    <div class="modal-header">
                        <h4 class="modal-title" id="exampleModalLabel1">Đơn Xin Nghỉ Phép</h4>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="span pull-right">
                                    <button class="btn btn-info fetchLeaveTotal">Tổng Số Ngày Nghỉ</button>
                                </div>
                                <br>
                            </div>
                            <div class="form-group">
                                <label class="control-label">Thời Gian Nghỉ Phép</label><br>
                                ...
                                <label for="radio_3">Trên Một Ngày</label>
                            </div>
                            <div class="form-group">
                                <label class="control-label" id="hourlyFix">Ngày</label>
