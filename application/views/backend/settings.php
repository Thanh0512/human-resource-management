...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor"><i class="fa fa-cogs"></i> Cài Đặt</h3>
        </div>
                            ...
                            <form action="Add_Settings" id="fileUploadForm" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                                <div class="form-group clearfix">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <label for="img_url" class="custom-file-upload"><i class="fa fa-camera" aria-hidden="true"></i> Tải Lên Logo</label>
                                        <input type="file" value="" class="" id="img_url" name="img_url" aria-describedby="fileHelp">
                                    </div>
                                </div>
                                <div class="form-group clearfix">
                                    <label for="title" class="col-md-3">Tiêu Đề Trang</label>
                                    <div class="col-md-9">
                                ...
                                <div class="form-group clearfix">
                                    <label for="description" class="col-md-3">Miêu Tả</label>
                                    <div class="col-md-9">
                                ...
                                <div class="form-group clearfix">
                                    <label for="copyright" class="col-md-3">Bản Quyền</label>
                                    <div class="col-md-9">
                                ...
                                <div class="form-group clearfix">
                                    <label for="address" class="col-md-3">Địa Chỉ 2</label>
                                    <div class="col-md-9">
                                ...
                                <div class="form-group clearfix">
                                    <div class="col-md-9 col-md-offset-3">
                                        ...
                                        <button type="submit" name="submit" id="btnSubmit" class="btn btn-success">Gửi</button>
