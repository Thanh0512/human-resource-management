...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor"><i class="fa fa-fax" style="color:#1976d2"> </i>Báo Cáo Ngày Nghỉ</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">Báo Cáo Ngày Nghỉ</li>
            </ol>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white">Danh Sách Báo Cáo</h4>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                            ...
                            <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Loại</th>
                                        <th>Số Ngày Nghỉ</th>
                                        <th>Ngày Bắt Đầu Nghỉ Phép</th>
                                        <th>Ngày Kết Thúc Nghỉ Phép</th>
                                        <!--<th>Total</th>-->
                                    </tr>
                                </thead>
                                <!-- <tfoot>
