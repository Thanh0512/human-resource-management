...
<div class="page-wrapper">
   ...
   <div class="row page-titles">
      <div class="col-md-5 align-self-center">
         <h3 class="text-themecolor"><i class="fa fa-briefcase"></i> Đơn Xin Công Tác
         </h3>
      </div>
      <div class="col-md-7 align-self-center">
         <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Đơn Xin Công Tác
            </li>
         </ol>
      </div>
   </div>
         ...
         <div class="col-12">
            <button type="button" class="btn btn-info">
               ...
               <a data-toggle="modal" data-target="#appmodel" data-whatever="@getbootstrap" class="text-white" id="addNewApplication">
                  <i class="" aria-hidden="true"></i> Thêm Đơn Xin
               </a>
            </button>
         </div>
      </div>
         ...
         <div class="col-12">
            <div class="card card-outline-info">
               <div class="card-header">
                  <h4 class="m-b-0 text-white"> Danh Sách Đơn Xin
                  </h4>
               </div>
               <div class="card-body">
                                 ...
                                 <?php } else { ?>
                                    <td class="jsgrid-align-center">
                                       ...
                                       <?php } elseif ($value->status == 'Not Approve') { ?>
                                          ...
                                          <a href="" title="Edit" class="btn btn-sm btn-info waves-effect waves-light Status " data-id="<?php echo $value->id; ?>" data-value="Approved" data-duration="<?php echo $value->total_days; ?>">Chấp Thuật
                                          </a>
                                          <br>

                                          <a href="" title="Edit" class="btn btn-sm btn-info waves-effect waves-light  Status" data-id="<?php echo $value->id; ?>" data-value="Rejected">Từ Chối
                                          </a>
                                          <br>
                                       ...
                                       <?php if ($value->attendance_updated !== 'done' and $value->status == 'Approved'): ?>
                                          <a href="" id="closeAndUpdateFieldVisit" data-confirm="Are you sure want to close his field visit and update the attendance?" title="Mark as done" class="btn btn-sm btn-info waves-effect waves-light" data-id="<?php echo $value->id; ?>" data-employeeID="<?php echo $value->em_code; ?>">
                                             <i class="fa fa-scissors"></i> Cập nhật chấm công
                                          </a>
                                       <?php endif; ?>
                                    </td>
                                 <?php } ?>
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-6">
                           ...
                           <div class="form-group" id="returnDate">
                              <label class="control-label">Ngày trở lại thực tế
                              </label>
