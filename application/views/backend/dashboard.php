...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor"><i class="fa fa-braille" style="color:#1976d2"></i>&nbsp Trang chủ</h3>
        </div>
                        ...
                        <div class="d-flex flex-row">
                            ...
                            <div class="m-l-10 align-self-center">
                                <h3 class="m-b-0">
                                    ...
                                    ?> Nhân viên</h3>
                                <a href="<?php echo base_url(); ?>employee/Employees" class="text-muted m-b-0">Xem chi tiết</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6 col-lg-3 col-xlg-3">
                <div class="card card-inverse card-info">
                    <div class="box bg-primary text-center">
                        ...
                        <h6 class="text-white">Cựu nhân viên</h6>
                    </div>
                </div>
            </div>
            <!-- Column -->
            <div class="col-md-6 col-lg-3 col-xlg-3">
                <div class="card card-info card-inverse">
                    <div class="box text-center">
                        ...
                        <h6 class="text-white">Đơn xin nghỉ phép đang chờ xử lý</h6>
                    </div>
                </div>
            </div>
            <!-- Column -->
            ...
            <div class="col-md-6 col-lg-3 col-xlg-3">
                <div class="card card-inverse card-success">
                    <div class="box text-center">
                        ...
                        <h6 class="text-white">Đơn xin vay tiền</h6>
                    </div>
                </div>
            </div>
            <!-- Column -->
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Dự án đang chạy</h4>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Danh sách việc cần làm</h4>
                        <h6 class="card-subtitle">Danh sách nhiệm vụ tiếp theo của bạn để hoàn thành</h6>
                        ...
                        <div class="new-todo">
                            <form method="post" action="add_todo" enctype="multipart/form-data" id="add_todo">
                                <div class="input-group">
                                    <input type="text" name="todo_data" class="form-control" style="border: 1px solid #fff !IMPORTANT;" placeholder="Nhập việc cần làm mới...">
