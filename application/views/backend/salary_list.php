...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor"><i class="fa fa-bars" aria-hidden="true"></i> Quản Lý Lương</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active"><i class="fa fa-university" aria-hidden="true"></i> Quản Lý Lương</li>
            </ol>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row m-b-10">
            <div class="col-12">
                ...
                <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url(); ?>Payroll/Generate_salary" class="text-white"><i class="" aria-hidden="true"></i> Tạo Bảng Lương</a></button>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                ...
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white"><i class="fa fa-hourglass-start" aria-hidden="true"></i> Danh Sách Bảng Lương
                        </h4>
                    </div>
                    <div class="card-body">
                            ...
                            <table id="example123" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Trạng Thái</th>
                                        <th class="jsgrid-align-center">Hoạt Động</th>
                                    </tr>
                                </thead>
                                <!-- <tfoot>
                                            <tr>
                ...
                <div class="modal-content ">
                    ...
                    <form method="post" action="Add_Salary" id="salaryform" enctype="multipart/form-data">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label class="control-label">Thuê Nhà</label>
