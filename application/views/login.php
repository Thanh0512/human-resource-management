...
<body>
    ...
    <section id="wrapper" class="login-register login-sidebar" style="background-image:url(<?php echo base_url(); ?>assets/images/background/bg.png);">
            ...
            <div class="card-body loginpage">
                ...
                <form class="form-horizontal form-material" method="post" id="loginform" action="login/Login_Auth">
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="remember-me">Nhớ Tôi </label>
                    </div>
                    <div class="form-group text-center m-t-20">
                        <div class="col-xs-12">
                            <button class="btn btn-success btn-login btn-block text-uppercase waves-effect waves-light" type="submit">Đăng Nhập</button>
                        </div>
                    </div>
                </form>
            </div>
