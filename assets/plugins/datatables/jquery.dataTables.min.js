...
(function(h) {
    ...
    function oa(a, b) {
        ...
        return b.map(function(b, e) { c = Ka(a, e); return N(a, c.data, e, c.cells) })
    }
    ...
    function R(a) {
        if (h.isPlainObject(a)) {
            var b = {};
            h.each(a, function(a, c) { c && (b[a] = R(c)) });
    ...
    function ma(a) {
        ...
        if (a.scrollBarVis !== L && a.scrollBarVis !== k) a.scrollBarVis = L, Z(a);
            ...
            }, Q), I(function(a, b) { a.style.width = y[b] }, P), h(Q).height(0));
            I(function(a, b) {
    ...
    function fb(a) {
        h.each({ num: function(b) { return Ba(b, a) }, "num-fmt": function(b) { return Ba(b, a, Za) }, "html-num": function(b) { return Ba(b, a, Ca) }, "html-num-fmt": function(b) { return Ba(b, a, Ca, Za) } }, function(b, c) {
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            oPaginate: { sFirst: "First", sLast: "Last", sNext: "Sau", sPrevious: "Trước" },
            sEmptyTable: "No data available in table",
            sInfo: "Hiện _START_ từ _END_ của _TOTAL_ mục",
            sInfoEmpty: "Hiện  0 từ 0 của 0 mục",
    ...
    m.ext = x = { buttons: {}, classes: {}, builder: "-source-", errMode: "alert", feature: [], search: [], selector: { cell: [], column: [], row: [] }, internal: {}, legacy: { ajax: null }, pager: {}, renderer: { pageButton: {}, header: {} }, order: {}, type: { detect: [], search: {}, order: {} }, _unique: 0, fnVersionCheck: m.fnVersionCheck, iApiIndex: 0, oJUIClasses: {}, sVersion: m.version };
    h.extend(x, {
                    ...
                    r = function(b, d) {
                        ...
                        for (t = d.length; k < t; k++) {
                            ...
                            if (h.isArray(s)) {
                                ...
                                if (m !== null) {
                                    u = h("<a>", { "class": g.sPageButton + " " + l, "aria-controls": a.sTableId, "aria-label": i[s], "data-dt-idx": p, tabindex: a.iTabIndex, id: c === 0 && typeof s === "string" ? a.sTableId + "_" + s : null }).html(m).appendTo(b);
                                    Ya(u, { action: s }, v);
                                    p++
                                }
                            }
